...
def sensitivities_and_data_fitting():
...
def Using_Battery_Parameter_eXchange_files():
...
def Optimising_geometric_parameters():
...
if __name__ == '__main__':
    # change_input_current()
    # parameter_values()
    # parameterisation()
    # sensitivities_and_data_fitting()
    # Using_Battery_Parameter_eXchange_files()
    Optimising_geometric_parameters()
